...
4. Click **Connect** to authenticate your GitLab account and initiate the connection. ![Connect GitLab](/images/integrations/integrations/gitlab/connect-gitlab.webp)

5. Review the requested permissions and click **Authorize Plane** to grant access. ![Authorize Plane](/images/integrations/integrations/gitlab/authorize-plane.webp)
...
![Connect GitLab project](/images/integrations/integrations/gitlab/connect-gitlab-project.webp)
...
![Connect Plane project](/images/integrations/integrations/gitlab/connect-plane-project.webp)
