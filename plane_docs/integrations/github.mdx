...
![Connect GitHub](/images/integrations/integrations/github/connect-github.webp)
...
![Connect personal account](/images/integrations/integrations/github/connect-personal-account.webp)
...
![Connect member personal account](/images/integrations/integrations/github/connect-personal-account-member.webp)
...
![Repository mapping](/images/integrations/integrations/github/repository-mapping.webp)

1. Go to the **Repository Mapping** section under **Integrations**.

2. Click **Add** to create a new mapping. ![Sync repo and project](/images/integrations/integrations/github/sync-repo-and-project.webp)
...
1. Add the `Plane` label to an issue in GitHub to create and sync the issue in Plane. ![Add Plane label](/images/integrations/integrations/github/add-plane-label.webp)
2. Plane posts a link back to the GitHub issue, confirming the connection. ![Synced issue from GitHub](/images/integrations/integrations/github/synced-issue-from-github.webp)
3. A new work item is created in Plane with a link to the GitHub issue. ![Creates issue in Plane](/images/integrations/integrations/github/creates-plane-issue.webp)

### Plane -> GitHub[​](#plane---github "Direct link to Plane -> GitHub")

1. Add the `GitHub` label to a work item in Plane to sync it to GitHub. ![Add GitHub label](/images/integrations/integrations/github/add-github-label.webp)
2. A new issue is created in GitHub. ![Creates issue in GitHub](/images/integrations/integrations/github/create-github-issue.webp)
