---
title: "Manage seats, upgrades, and plans"
description: "Unlike a majority of SaaS, our subscription models on Pro and higher plans are per-seat, not per-users. Learn why this model works great for you and how to manage your members versus seats."
---

## How the per-seat model and billing work[​](#how-the-per-seat-model-and-billing-work "Direct link to How the per-seat model and billing work")
...
* You are billed per workspace you upgrade. On both Cloud and self-hosted Plane you can upgrade your workspace from **Billing and plans**. On self-hosted instances, your license key only unlocks one workspace.
  ...
  ![Billings and plans](/images/workspaces-and-users/activate-license/billing-and-plans-cloud.webp)
...
* In the upgrade flow, you get as many seats as paid users—Admins or Members already in your workspace. For self-hosted instances, if you upgrade through the Prime portal, you can specify the number of seats you would like to purchase. You can also change this number later from the **Members** screen in **Workspace settings**.
  ...
  ![Add seats](/images/workspaces-and-users/activate-license/add-seats.webp)
...
* When you remove members, their seats are freed up and go to the available pool so you can assign them to other users. **Removing members doesn't automatically remove seats. You must remove seats separately to affect your billing.** See [Manage paid users](/workspaces-and-users/upgrade-plan#manage-paid-users) for more details.
...
### Free tiers, cancelations, and downgrades[​](#free-tiers-cancelations-and-downgrades "Direct link to Free tiers, cancelations, and downgrades")
...
#### Older workspaces[​](#older-workspaces "Direct link to Older workspaces")
...
#### All workspaces[​](#all-workspaces "Direct link to All workspaces")
...
Just head to the **Billing and plans** section in your [Workspace settings](/core-concepts/workspaces/overview#workspace-settings) and click the **Start free trial** button.

![Free trial](/images/workspaces-and-users/activate-license/free-trial.webp)
