---
title: "Turbocharge speed and performance"
description: "Hyper Mode is a feature in Plane designed to make your workspace faster and more responsive. By storing workspace data directly on your machine, Hyper Mode reduces the time it takes to load work items, modules, cycles, labels, members, and other workspace elements when using work item layouts."
---
...
![Enable Hyper Mode](/images/performance/product/enable-hyper-mode.webp)
