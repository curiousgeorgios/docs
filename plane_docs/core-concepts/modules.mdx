...
![Create module](/images/core-concepts/modules/create-module.webp)
...
* Add new or existing work items directly from the Module page. ![Add work items to module](/images/core-concepts/modules/add-issues-to-module.webp)

* Assign multiple Modules to a work item from its properties. For instance, a work item can belong to both a Feature module and a Release module simultaneously. ![Work item module property](/images/core-concepts/modules/issue-module-property.webp)
...
![Module progress](/images/core-concepts/modules/module-progress.webp)
...
![View Module details](/images/core-concepts/modules/view-module-details.webp)
...
* **Timeline layout** – Displays the sequence of goals and their progress, helping you ensure your project is on track. ![Module layout](/images/core-concepts/modules/module-gallery.webp)
