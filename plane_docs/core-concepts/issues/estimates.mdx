...
1. By default, your project won’t have an estimate system in place. To set one up, go to **Project > Settings** and select the **Estimates** tab.
   ...
   ![Add estimate system](/images/core-concepts/issues/projects/enable-estimate-system.webp)
...
3. You can choose from the following options:
   ...
   * Categories
   ...
   ![Choose estimate type](/images/core-concepts/issues/projects/choose-estimate-system.webp)
...
5. When you are done, turn on the **Enable estimates for my project** toggle. ![Enable estimate type](/images/core-concepts/issues/projects/enable-estimate-toggle.webp)
...
![Edit estimate system](/images/core-concepts/issues/projects/edit-estimate-system.webp)
