---
title: "Work items"
description: "In Plane, a work item serves as the fundamental unit of work. They represent the tasks you need to accomplish to make progress Think of work items as the to-dos of your project management flow—assignable, trackable, and actionable."
---
...
![Create work item](/images/core-concepts/issues/issues/create-issue-modal.webp)
...
![Quick add work item](/images/core-concepts/issues/issues/issue-quick-add.webp)
...
![work item-side-peek](/images/core-concepts/issues/issues/issue-side-peek.webp)
...
![sub-work items](/images/core-concepts/issues/issues/issue-sub-issues.webp)
...
![Work item relations](/images/core-concepts/issues/issues/issue-relations.webp)
...
![Add links and attachments](/images/core-concepts/issues/issues/links-and-attachments.webp)
...
![issue-activity-comments](/images/core-concepts/issues/issues/issue-activity-comments.webp)
...
![archived-work items](/images/core-concepts/issues/issues/archived-issues.webp)
...
* **Auto-archive closed work items** You can set up an automation to archive work items that are marked as closed. This helps keep your active project board clean and organized, while still retaining closed work items for reference. You can customize the time period after which closed work items will automatically be moved to the archive. ![Project archive automation](/images/core-concepts/issues/projects/auto-archive-closed-issues.webp)

* **Auto-close work items** You can also automate the closing of work items that are still open after a certain period of time. This is useful for ensuring that work items don’t remain open unnecessarily, helping to keep your project board organized and up to date. The automation will move all open work items matching the time period to a selected closed state. ![Project close automation](/images/core-concepts/issues/projects/auto-close-issues.webp)
