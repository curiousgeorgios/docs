---
title: "Add, configure and control your work item types"
description: "Pro"
---
...
3. Click the **Enable** button to start creating work item types for your project. ![Enable work item type](/images/core-concepts/issues/issues/enable-issue-types.webp)
4. The default type is called `Issue`. Click the **Add Work item Type** button to create a new work item type. ![Add work item type](/images/core-concepts/issues/issues/add-issue-type.webp)
5. In the **Create work item type** modal, type name, and description, and choose a background color and an icon to represent the work item type. Click the **Create work item type** button. ![Create work item type](/images/core-concepts/issues/issues/create-issue-type.webp)
6. Switch on the toggle button to allow users to select the work item type when creating work items and sub-work items. ![Activate work item type](/images/core-concepts/issues/issues/activate-issue-type.webp)
...
1. Under the work item type, click **Add New Property** to create custom fields. ![Add new property](/images/core-concepts/issues/issues/add-new-property.webp)
2. Specify values for **Title**, **Description** and **Property type** of the new property. ![Property details](/images/core-concepts/issues/issues/property-details.webp)
...
* The system ensures that all properties marked as mandatory are filled before creating the work item. ![Use work item types](/images/core-concepts/issues/issues/use-issue-type.webp)
...
2. Hover over to the right of the work item ID and click **Switch work item type**. Alternatively, you can click **Edit** from the work item's ellipsis (•••) menu to open the **Update work item** modal directly. ![Switch work item type](/images/core-concepts/issues/issues/switch-issue-type.webp)
3. Choose the new work item type from the dropdown next to your project name. ![Update work item type](/images/core-concepts/issues/issues/update-issue-type.webp)
...
3. At the bottom of your screen, open the **Work item type** dropdown and pick the new work item type. ![Bulk update work item types](/images/core-concepts/issues/issues/bulk-update-issue-types.webp)
...
2. Toggle off the switch next to the work item type you want to disable. ![Disable work item types](/images/core-concepts/issues/issues/disable-issue-types.webp)
